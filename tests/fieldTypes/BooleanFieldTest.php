...
class BooleanFieldTest extends Orchestra\Testbench\TestCase
{
	...
	public function testUpdateAttribute()
	{
		...
		$result = $bus->dispatch( new Congraph\Eav\Commands\Attributes\AttributeUpdateCommand($params, 15) );
	...
	public function testFilterEntity()
	{
		...
		$result = $bus->dispatch( new Congraph\Eav\Commands\Entities\EntityGetCommand(['filter' => ['fields.test_boolean_attribute' => '0']]));
		// $this->d->dump($result->toArray());
		...
		$result = $bus->dispatch( new Congraph\Eav\Commands\Entities\EntityGetCommand(['filter' => ['fields.test_boolean_attribute' => ['ne' => '1']]]));
		// $this->d->dump($result->toArray());
		$this->assertTrue($result instanceof Congraph\Core\Repositories\Collection);
		$this->assertEquals(1, count($result));
		$this->assertEquals(0, $result[0]->fields->test_boolean_attribute);

		$result = $bus->dispatch( new Congraph\Eav\Commands\Entities\EntityGetCommand(['filter' => ['fields.test_boolean_attribute' => '1']]));
		// $this->d->dump($result->toArray());
		$this->assertTrue($result instanceof Congraph\Core\Repositories\Collection);
