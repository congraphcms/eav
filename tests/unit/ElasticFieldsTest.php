...
class ElasticFieldsTest extends Orchestra\Testbench\TestCase
{
	...
	public function testAssetCollectionField()
	{
		...
		$changedEntity = $repo->fetch($entityWithFile->id);
		$this->assertTrue(count($changedEntity->fields->test_asset_attribute) > 0);
		foreach ($changedEntity->fields->test_asset_attribute as $value)
		{
			$this->assertNotEqual(1, $value['id']);
		}
