...
/**
 * EntityTypeGetValidator class
 * 
 * Validating command for getting entity types
 * 
 * 
 ...
 * @version  	0.1.0-alpha
 */
class EntityTypeGetValidator extends Validator
{
	...
	/**
	 * Create new EntityTypeGetValidator
	 * 
	 * @return void
	 */
